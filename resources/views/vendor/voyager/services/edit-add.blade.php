...
@section('css')
    ...
    <style>
        ...
        th.sorting[aria-label*="About us Description"] {
    max-width: 329px;
}
...
<script>
    $(document).ready(function() {
        ...
        $('input[name="i18n_selector"]').on('change', function() {
            // Get the selected language
            const selectedLang = $(this).attr('id');

            if (selectedLang === 'ar') {
                // Apply right-to-left (RTL) styling to all text inputs when Arabic is selected
                $('input[type="text"]').css({
                ...
                // Apply left-to-right (LTR) styling to all text inputs when English is selected
                $('input[type="text"]').css({
