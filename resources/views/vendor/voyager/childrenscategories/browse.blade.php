                                    ...
                                    <tr>
                                        ...
                                        @foreach($dataType->browseRows as $row)
                                            ...
                                            <td>
                                                ...
                                                <img src="
                                                @if( !empty($data->{$row->field}) && !filter_var($data->{$row->field}, FILTER_VALIDATE_URL) )
                                                    {{ Voyager::image( $data->{$row->field} ) }}
                                                @elseif( filter_var($data->{$row->field}, FILTER_VALIDATE_URL) )
                                                    {{ $data->{$row->field} }}
                                                @else
                                                    {{ asset('assets/img/icons/no_image.jpg	') }} {{-- Path to your default image --}}
                                                @endif
                                                " style="width:100px">
